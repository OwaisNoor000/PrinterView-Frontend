...
export default function Summary({className}:SummaryProps){
    ...
    // Fetch transcript data
       const fetchSummaryData = async ()=>{
            const res = await getSummary(interview_number);
            console.log(res);
            setLines(res);
       }
